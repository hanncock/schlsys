...
class CreateInvoice extends StatefulWidget {
  ...
  const CreateInvoice({Key? key,required this.invoicedata,required this.sessionStateStream}) : super(key: key);
...
class _CreateInvoiceState extends State<CreateInvoice> {
  ...
  late var invoiceNum = widget.invoicedata?[0]['invoiceNum'];
  late var id = widget.invoicedata?[0]['invoiceId'];
  late var companyId = widget.invoicedata?[0]['companyId'];
